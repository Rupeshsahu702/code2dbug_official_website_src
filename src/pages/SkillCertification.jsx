    ...
    return (
        <>
            ...
            <div className='flex bg-grade relative z-0 flex-col px-[3vw] sm:px-[25vw]  pt-[30vw] sm:pt-[10vw] pb-[5vw] gap-[5vw] ' >
                <h1 className=' text-white text-5xl font-semibold font-sans ' >Skill Certification Program</h1>
            ...
            <div className='px-[3vw] py-[10vw]  sm:px-[24vw] sm:py-[4vw] ' >
                <div className=' flex flex-col items-baseline gap-[10vw] sm:gap-[2vw] '>
                    <p className='text-lg font-sans' >Best for
                        Beginners and freshers seeking proof of skill and a stronger resume artifact without a long-term commitment.</p>
                    <p className='text-lg font-sans' > Enhance your professional growth with our Skill Certification Courses designed to match today’s industry standards. Each program offers hands-on learning, expert guidance, and real-world applications to help you master in-demand skills.</p>
                    <h3 className='text-xl font-semibold' >WHAT YOU'LL LEARN</h3>
                    <h2 className='underline text-lg uppercase ' >Scope & Features</h2>
                    <ul class="list-disc pl-6  ">
                        <li className='ml-[2vw] mb-[1vw] text-lg ' >4–6 bite-sized lessons (video or slides) with notes</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg '  >1 basic skill assessment (20–30 MCQs + 1 task)</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg ' >Resume template + build guidance</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg ' >7-day forum/email support</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg ' >LMS access for 30 days</li>
                    </ul>
                    <h2 className='underline text-lg uppercase ' > Outcomes</h2>
                    <ul class="list-disc pl-6  ">
                        <li className='ml-[2vw] mb-[1vw] text-lg ' >QR-verifiable skill certificate</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg '  >Portfolio-ready task sample</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg ' >Updated resume with basic proof of work</li>
                    </ul>
                    ...
                    <h2 className='underline text-lg mt-6'>ADD-ONS (AVAILABLE WITH ANY PACKAGE; PRICED SEPARATELY)</h2>
                    <ul className="list-disc pl-6">
                        <li className='ml-[2vw] mb-[1vw] text-lg'>1:1 resume review </li>
                        <li className='ml-[2vw] mb-[1vw] text-lg'>LinkedIn rewrite </li>
                        <li className='ml-[2vw] mb-[1vw] text-lg'>GitHub cleanup and formatting </li>
                    </ul>

                    {/* Timelines Section */}
                    <h2 className='underline text-lg mt-6'>TYPICAL TIMELINES & CADENCE</h2>
                    <ul className="list-disc pl-6">
                        <li className='ml-[2vw] mb-[1vw] text-lg'>Duration: 3–5 days self-paced</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg'>Assessment and certificate within 48 hours post-submission</li>
                    </ul>

                    {/* Terms & Policies Section */}
                    <h2 className='underline text-lg mt-6'>MARGIN-PROTECTING TERMS & POLICIES</h2>
                    <ul className="list-disc pl-6">
                        <li className='ml-[2vw] mb-[1vw] text-lg'>No extensions after 30-day access</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg'>Certificate issued only for ≥70% score</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg'>Single submission attempt; extra attempts priced separately</li>
                    </ul>

                    {/* Who Should Apply Section */}
                    <h2 className='underline text-lg mt-6'>WHO SHOULD APPLY</h2>
                    <ul className="list-disc pl-6">
                        <li className='ml-[2vw] mb-[1vw] text-lg'>Students or jobseekers building their first resume</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg'>Professionals pivoting into tech/digital roles</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg'>Anyone who needs a formal proof of a single skill</li>
                    </ul>

                    <h3 className='text-xl font-semibold' >WHAT YOU'LL DO</h3>
                    <ul class="list-disc pl-6  ">
                        <li className='ml-[2vw] mb-[1vw] text-lg ' > <span className='font-bold' >Skill Mastery: </span>  Develop practical, job-ready expertise through hands-on projects and real-world problem-solving exercises.</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg '  > <span className='font-bold' >  Applied Learning: </span> Go beyond theory — apply concepts to case studies, assignments, and industry-relevant challenges.</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg ' >  <span className='font-bold' >Attention to Detail: </span> Learn to meet professional standards with precision, accuracy, and consistency in every submission.</li>
                        <li className='ml-[2vw] mb-[1vw] text-lg ' >  <span className='font-bold' >Adaptability: </span> Build the confidence to apply your certified skills across different tools, roles, and work environments.</li>
                    </ul>
